...
Delta         = [0.01 0.01 0 0.01*%pi/180 0.01*%pi/180 0.004*%pi/180];
dt            = 1/10;
dotx          = Delta / dt;
dotu          = Delta (4:6)'/dt;
dotp          = Delta (1:3)'/dt;
...
smHorGlinCorr_incremental_m = linearCorrection(smHorG_incremental_m,DeltaS_m, Np_m);
// 3th method
//smHorGlinCorr_from2D_m = cld_predHorGlobalMire((sm_m-DeltaS_m),Zm_m,Up_m,Te_m,Np_m);
smHorGlinCorr_from2D_m= linearCorrection(smHorG_from2D_m,DeltaS_m, Np_m);
