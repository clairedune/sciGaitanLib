...
hf_10           = createPlanImage(10,xl_m,xu_m,"Real features");
mire2DDraw(s_m,cote_m,1); // initial target position
mireEvolutionMulticolor(Np_m,sHorG_m,'-') ; // motion then projection
//show_pixmap();
//pause
mireEvolutionMulticolor(Np_m,sHorG_incremental_m,'.-') ; // incremental
//show_pixmap();
//pause
mireEvolutionMulticolor(Np_m,sHorG_from2D_m,'.') ; // P estimation then motion then projection
show_pixmap();

disp('3 features estimation with global')
pause
...
hf_11           = createPlanImage(11,xl_m,xu_m,"Estimation of measured features");
mire2DDraw(s_m,cote_m,1); // initial target position
mireEvolutionMulticolor(Np_m,smHorG_m,'-') ; // motion then projection
//show_pixmap();
//pause
mireEvolutionMulticolor(Np_m,smHorG_incremental_m,'.-') ; // incremental
//show_pixmap();
//pause
mireEvolutionMulticolor(Np_m,smHorG_from2D_m,'.') ; // P estimation then motion then projection
show_pixmap();
...
// 3th method
smHorGlinCorr_from2D_m = ga_predHorGlobalMire((sm_m-DeltaS_m),Zm_m,Up_m,Te_m,Np_m);



hf_12           = createPlanImage(12,xl_m,xu_m,"Estimation of linear corrected features");
mire2DDraw(s_m,cote_m,1); // initial target position
...
show_pixmap();
pause
mireEvolutionMulticolor(Np_m,smHorGlinCorr_from2D_m,'-.') ; // P estimation then motion then projection
show_pixmap();
pause
