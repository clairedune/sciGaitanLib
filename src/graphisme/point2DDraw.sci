...
//-----------------------------//
// mireEvolutionMulticolor
// date 5/01/2010
// author claire dune
//------------------------------//
function mireEvolutionMulticolor(Np,M,attribute)
  // number of points = number of lin2/2 
   ...
   k=1;
    ...
    for i=1:Np
      ...
      plot(x,y,attribute+'b')
      
    
endfunction  

function mireEvolutionDraw(Np,M,width,col)
